...
systemctl enable sysctl-custom
    ...
    wget -O /tmp/gost.tar.gz https://github.com/go-gost/gost/releases/download/v3.0.0-nightly.20240624/gost_3.0.0-nightly.20240624_linux_amd64.tar.gz
...
# If option 6 is selected
    ...
    case "$gost_version_choice" in
        ...
        2)
            echo $'\e[32mInstalling Gost version 3.0.0, please wait...\e[0m' && \
            wget -O /tmp/gost.tar.gz https://github.com/go-gost/gost/releases/download/v3.0.0-nightly.20240611/gost_3.0.0-nightly.20240611_linux_amd64.tar.gz
    tar -xvzf /tmp/gost.tar.gz -C /usr/local/bin/
    chmod +x /usr/local/bin/gost
            echo $'\e[32mGost installed successfully.\e[0m'
            ;;
